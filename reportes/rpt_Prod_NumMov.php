...
//TODO:CABECERA.
    ...
    $sqlPro=mysql_query("SELECT 
                            ...
                            GROUP BY mr.num_mov 
                            ORDER BY mr.fecha_hora" ) or die(mysql_error());
...
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", 'Responsable:');
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:C$fila");
$objPHPExcel->getActiveSheet()->setSharedStyle($subtitulo, "A$fila:C$fila");

$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", utf8_encode($resPro["nom_ing"]));
$objPHPExcel->getActiveSheet()->mergeCells("D$fila:H$fila");
...
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", 'Movimiento:');
$objPHPExcel->getActiveSheet()->mergeCells("A$fila:C$fila");
$objPHPExcel->getActiveSheet()->setSharedStyle($subtitulo, "A$fila:C$fila");

$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'I20 - PRODUCCION');
$objPHPExcel->getActiveSheet()->mergeCells("D$fila:H$fila");
$objPHPExcel->getActiveSheet()->setSharedStyle($subtitulo, "D$fila:H$fila");
...
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", utf8_encode($res["cod_taller"]));
