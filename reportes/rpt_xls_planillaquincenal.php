...
//INICIO 3era HOJA
$objPHPExcel->createSheet(0); //crear hoja 3
$objPHPExcel->setActiveSheetIndex(0); //seleccionar hora 3
...
$sql=mysql_query("SELECT    tr.id_trab,
    ...
    NULL AS cant_monedas_1
        ...
        ( SELECT pp.id_trab, pp.dias, pp.monto_a_pagar, 
          ...
          IF( pp.id_fecha_pago1='".$id_seg_quin."' OR pp.id_fecha_pago2='".$id_seg_quin."' OR pp.id_fecha_pago3='".$id_seg_quin."' OR  pp.id_fecha_pago4='".$id_seg_quin."',  'SI', '0.00')  AS monto
        ...
        AND dme.id_fecha_pago1='".$id_seg_quin."'
        LEFT JOIN 
        ...
        AND sub.id_fecha_pago1='".$id_seg_quin."'
        LEFT JOIN 
        ( SELECT pp.id_trab, pp.dias, pp.monto_a_pagar, pp.tip_permiso, pp.id_fecha_pago1,
                 CONCAT (DATE_FORMAT(pp.fecha_procede, '%d/%m/%Y'),' AL ' , DATE_FORMAT(pp.fecha_hasta, '%d/%m/%Y')) AS fechas,
          IF( pp.id_fecha_pago1='".$id_seg_quin."' OR pp.id_fecha_pago2='".$id_seg_quin."' OR pp.id_fecha_pago3='".$id_seg_quin."' OR  pp.id_fecha_pago4='".$id_seg_quin."',  'SI', '0.00')  AS monto
        ...
        AND lco.id_fecha_pago1='".$id_seg_quin."'
        LEFT JOIN 
        ( SELECT pp.id_trab, pp.dias, pp.monto_a_pagar, pp.tip_permiso, pp.id_fecha_pago1,
                 CONCAT (DATE_FORMAT(pp.fecha_procede, '%d/%m/%Y'),' AL ' , DATE_FORMAT(pp.fecha_hasta, '%d/%m/%Y')) AS fechas,
          IF( pp.id_fecha_pago1='".$id_seg_quin."' OR pp.id_fecha_pago2='".$id_seg_quin."' OR pp.id_fecha_pago3='".$id_seg_quin."' OR  pp.id_fecha_pago4='".$id_seg_quin."',  'SI', '0.00')  AS monto
        ...
        AND lsi.id_fecha_pago1='".$id_seg_quin."'
        LEFT JOIN 
        (SELECT tr.id_trab, 
...
(SELECT (@i := @i + 1) AS id ,
 ...
 FROM (SELECT @i:=0) r
   INNER JOIN fechas fe
   LEFT JOIN cronograma_dsctos_horasdias cp ON 
...
LEFT JOIN cronograma_pagos cp ON 
    cp.id_cp='".$id_pri_quin."'
LEFT JOIN  cronograma_horasextras ch ON 
    ch.id_cp='".$id_pri_quin."'
LEFT JOIN  cronograma_dsctos_horasdias cd ON 
