...
$objPHPExcel->getActiveSheet()->setTitle("Dsctos y H.Extras"); //establecer titulo de hoja
...
$objPHPExcel->getActiveSheet()->setTitle("Planilla"); //establecer titulo de hoja
...
$sql=mysql_query("SELECT    tr.id_trab,
    ...
    IF(vac.monto='SI', vac.fechas, '' )  AS fecha_vacaciones,
    IF(vac.monto='SI', vac.dias, '' )    AS cant_dias_vacaciones,
    ...
    NULL AS cant_monedas_1
        ...
        LEFT JOIN pago_destajeros     AS pd   ON pd.id_trab=tr.id_trab    AND pd.id_pd=36
        LEFT JOIN abono_regularizacion    AS ar   ON ar.id_trab=tr.id_trab    AND ar.fec_abo_reg=36
        LEFT JOIN descuentos_judiciales   AS dj   ON dj.id_trab=tr.id_trab    AND dj.est_des_jud='1'
        LEFT JOIN 
        ( SELECT pre.id_trab, CASE 
          WHEN  pre.fec_des1=36 THEN mon_des1
          WHEN  pre.fec_des2=36 THEN mon_des2
          WHEN  pre.fec_des3=36 THEN mon_des3 
          WHEN  pre.fec_des4=36 THEN mon_des4
          WHEN  pre.fec_des5=36 THEN mon_des5 
          WHEN  pre.fec_des6=36 THEN mon_des6
          WHEN  pre.fec_des7=36 THEN mon_des7 
          WHEN  pre.fec_des8=36 THEN mon_des8
          WHEN  pre.fec_des9=36 THEN mon_des9 
          WHEN  pre.fec_des10=36 THEN mon_des10
          WHEN  pre.fec_des11=36 THEN mon_des11
          WHEN  pre.fec_des12=36 THEN mon_des12
          WHEN  pre.fec_des13=36 THEN mon_des13
          WHEN  pre.fec_des14=36 THEN mon_des14
          WHEN  pre.fec_des15=36 THEN mon_des15
          WHEN  pre.fec_des16=36 THEN mon_des16
          WHEN  pre.fec_des17=36 THEN mon_des17
          WHEN  pre.fec_des18=36 THEN mon_des18
          WHEN  pre.fec_des19=36 THEN mon_des19
          WHEN  pre.fec_des20=36 THEN mon_des20
          WHEN  pre.fec_des21=36 THEN mon_des21
          WHEN  pre.fec_des22=36 THEN mon_des22 
          WHEN  pre.fec_des23=36 THEN mon_des23
          WHEN  pre.fec_des24=36 THEN mon_des24
          WHEN  pre.fec_des25=36 THEN mon_des25
          WHEN  pre.fec_des26=36 THEN mon_des26
          WHEN  pre.fec_des27=36 THEN mon_des27
          WHEN  pre.fec_des28=36 THEN mon_des28
          WHEN  pre.fec_des29=36 THEN mon_des29
          WHEN  pre.fec_des30=36 THEN mon_des30  
          ELSE '0.00'  END
          AS monto
        ...
        ( SELECT did.id_trab, CASE 
          WHEN  did.fec_des1=36 THEN mon_des1
          WHEN  did.fec_des2=36 THEN mon_des2
          WHEN  did.fec_des3=36 THEN mon_des3 
          ELSE '0.00'  END
          AS monto
        ...
        ( SELECT dv.id_trab, CASE 
          WHEN  dv.fec_des1=36 THEN mon_des1
          WHEN  dv.fec_des2=36 THEN mon_des2
          WHEN  dv.fec_des3=36 THEN mon_des3 
          ELSE '0.00'  END
          AS monto
        ...
        ( SELECT dm.id_trab, CASE 
          WHEN  dm.fec_des1=36 THEN mon_des1
          WHEN  dm.fec_des2=36 THEN mon_des2
          WHEN  dm.fec_des3=36 THEN mon_des3 
          ELSE '0.00'  END
          AS monto
        ...
        ( SELECT aa.id_trab, CASE 
          WHEN  aa.fec_des1=36 THEN mon_des1
          WHEN  aa.fec_des2=36 THEN mon_des2
          WHEN  aa.fec_des3=36 THEN mon_des3 
          ELSE '0.00'  END
          AS monto
        ...
        ( SELECT pp.id_trab, pp.dias, pp.monto_a_pagar, 
          ...
          IF( pp.id_fecha_pago1='22' OR pp.id_fecha_pago2='22' OR pp.id_fecha_pago3='22' OR  pp.id_fecha_pago4='22',  'SI', '0.00')  AS monto
        ...
        ( SELECT pp.id_trab, pp.dias, pp.monto_a_pagar,  pp.id_fecha_pago1,
                 CONCAT (DATE_FORMAT(pp.fecha_procede, '%d/%m/%Y'),' AL ' , DATE_FORMAT(pp.fecha_hasta, '%d/%m/%Y')) AS fechas,
          IF( pp.id_fecha_pago1='22' OR pp.id_fecha_pago2=36 OR pp.id_fecha_pago3=36 OR  pp.id_fecha_pago4=36,  'SI', '0.00')  AS monto
          FROM permiso_personal pp
          WHERE pp.tip_permiso='DM'
        ) AS dme  ON dme.id_trab=tr.id_trab
        AND dme.id_fecha_pago1='22'
        LEFT JOIN 
        ( SELECT pp.id_trab, pp.dias, pp.monto_a_pagar, pp.tip_permiso, pp.id_fecha_pago1,
                 CONCAT (DATE_FORMAT(pp.fecha_procede, '%d/%m/%Y'),' AL ' , DATE_FORMAT(pp.fecha_hasta, '%d/%m/%Y')) AS fechas,
          IF( pp.id_fecha_pago1=36 OR pp.id_fecha_pago2=36 OR pp.id_fecha_pago3=36 OR  pp.id_fecha_pago4=36,  'SI', '0.00')  AS monto
          FROM permiso_personal pp
          WHERE pp.tip_permiso IN ('LM','LP','FD', 'FF')
        ) AS sub  ON sub.id_trab=tr.id_trab
        AND sub.id_fecha_pago1='22'
        LEFT JOIN 
        ( SELECT pp.id_trab, pp.dias, pp.monto_a_pagar, pp.tip_permiso, pp.id_fecha_pago1,
                 CONCAT (DATE_FORMAT(pp.fecha_procede, '%d/%m/%Y'),' AL ' , DATE_FORMAT(pp.fecha_hasta, '%d/%m/%Y')) AS fechas,
          IF( pp.id_fecha_pago1=36 OR pp.id_fecha_pago2=36 OR pp.id_fecha_pago3=36 OR  pp.id_fecha_pago4=36,  'SI', '0.00')  AS monto
        ...
        WHERE tr.id_trab IN ('1','62','105','101', '4', '19')
        ;
  ");  
