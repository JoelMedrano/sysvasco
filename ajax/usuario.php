...
switch ($_GET["op"]){
	...
	case 'verificar':
		...
		if (isset($fetch))
	    {
			...
			in_array(8,$valores)?$_SESSION['rrhh']=1:$_SESSION['rrhh']=0;
			in_array(9,$valores)?$_SESSION['reloj']=1:$_SESSION['reloj']=0;
			in_array(10,$valores)?$_SESSION['calendarios']=1:$_SESSION['calendarios']=0;
			in_array(11,$valores)?$_SESSION['udp']=1:$_SESSION['udp']=0;
