...
switch ($_GET["op"]){
	...
	case 'listarDetalle':
		...
		while ($reg = $rspta->fetch_object()) //COLOCAR NAME'S
				...
				{
					echo '<tr class="filas" size="3" id="fila'.$cont.'">  ><td><input type="text" size="1" readonly name="id_hor_per[]" value="'.$reg->id_hor_per.'"></td><td><input type="text" size="7" name="fecha[]" value="'.$reg->fecha.'" readonly></td><td><input type="text" size="30" readonly name="nombres[]" value="'.$reg->nombres.'"></td><td><input type="text" size="7" readonly name="tiempo_des[]" value="'.$reg->tiempo_des.'"></td><td><input type="text" size="7" autocomplete="off" name="tiempo_fin[]" value="'.$reg->tiempo_fin.'"></td><td><input type="text" size="10" readonly name="incidencia[]" value="'.$reg->incidencia.'"></td><td><input type="text" size="15" readonly name="permiso[]" value="'.$reg->permiso.'"></td><td><input type="text" size="25"  autocomplete="off" name="observacion[]" value="'.$reg->observacion.'"></td><td><input type="text" size="15" readonly name="situacion[]" value="'.$reg->situacion.'"></td><td><input type="text" size="15" readonly name="estado[]" value="'.$reg->estado.'"></td></tr>';
					$total=$periodo;
					$cont++;
				}
