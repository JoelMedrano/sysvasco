...
switch ($_GET["op"]){
	case 'guardaryeditar':
		...
		if (empty($id_trab)){
			$rspta=$trabajador_datos->insertar($nom_trab,$apepat_trab,$apemat_trab,$dir_trab,$urb_trab,$id_distrito,$departamento, $fec_nac_trab,$lug_nac_trab,$nacionalidad, $id_est_civil, $id_tip_doc, $num_doc_trab,
			...
			$rspta=$trabajador_datos->editar($id_trab,$nom_trab,$apepat_trab,$apemat_trab,$dir_trab,$urb_trab, $id_distrito, $departamento, $fec_nac_trab,$lug_nac_trab,$nacionalidad,$id_est_civil,
	...
	case 'desactivar':
		$rspta=$trabajador_datos->desactivar($id_trab, $usu_reg, $pc_reg, $fec_reg );
 		echo $rspta ? "Trabajador Inactivo" : "Trabajador no se puede desactivar";
	break;

	case 'activar':
		$rspta=$trabajador_datos->activar($id_trab);
 		echo $rspta ? "Trabajador Activo" : "Trabajador no se puede activar";
	break;

	case 'mostrar':
		$rspta=$trabajador_datos->mostrar($id_trab);
	...
	case 'listar':
		$rspta=$trabajador_datos->listar($id);
