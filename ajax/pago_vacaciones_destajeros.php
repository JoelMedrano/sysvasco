...
require_once "../modelos/Pago_Vacaciones_Destajeros.php";

$pvd=new Pago_Vacaciones_Destajeros();
...
switch ($_GET["op"]){
	case 'guardaryeditar':
		if (empty($nro_doc)){
			$rspta=$pvd->insertar($id_nomtrab,$_POST["id_periodo"],$_POST["fec_del"],$_POST["fec_al"],$_POST["tot_dias"],
			...
			$rspta=$pvd->editar($nro_doc, $_POST["correlativo"], $_POST["id_periodo"],$_POST["fec_del"],$_POST["fec_al"],$_POST["tot_dias"],$_POST["pen_dias"], $_POST["obser_detalle"], $_POST["obser"] );
		    $rspta=$pvd->insertar2($nro_doc, $CantItems, $_POST["correlativo"], $_POST["id_periodo"], $_POST["fec_del"],$_POST["fec_al"],$_POST["tot_dias"],$_POST["pen_dias"], $_POST["obser_detalle"], $_POST["obser"] );
	...
	case 'anular':
		$rspta=$pvd->anular($nro_doc);
 		echo $rspta ? "Venta anulada" : "Venta no se puede anular";
	break;

	case 'mostrar':
		$rspta=$pvd->mostrar($nro_doc);
