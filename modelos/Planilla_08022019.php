...
SELECT DISTINCT '$primera_quincena', tr.id_trab,
  IF( ADDTIME(
...
GROUP BY tr.id_trab; ";
  ...
  (
    CASE
      ...
      THEN (
        (
          DATEDIFF(tr.fec_sal_trab, cp.desde)
