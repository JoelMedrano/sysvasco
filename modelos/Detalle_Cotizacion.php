...
Class Detalle_Cotizacion
{
	...
	public function insertar($idarticulo,$cantidad)
	{
		$sql="INSERT INTO detalle_cotizacion (idarticulo,cantidad)
		VALUES ('$idarticulo','$cantidad')";
		return ejecutarConsulta($sql);
	}

	//Implementamos un método para editar registros
	public function editar($iddetalle_cotizacion,$idarticulo,$cantidad)
	{
		$sql="UPDATE detalle_cotizacion SET idarticulo='$idarticulo',cantidad='$cantidad' WHERE iddetalle_cotizacion='$iddetalle_cotizacion'";
		return ejecutarConsulta($sql);
	}
