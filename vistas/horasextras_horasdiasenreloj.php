              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                        ...
                        <h10>Nota:Solo un periodo debe estar habilitado cuando se requiera eligir cuales seran abonados x items(Pantalla: Habilitar abono x fila del reloj)</h10>
                        </div>
                    </div>
                    <!-- /.box-header -->
                    <!-- centro -->
                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12"  align="right">
                            <a data-toggle="modal" href="#myModal">
                              <button id="btnAgregarArt" type="button" class="btn btn-primary"> <span class="fa fa-plus"></span> Agregar Horas.Extras no abonadas de otro Periodo de Pago</button>
                            </a>
                          </div>
