                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h1 class="box-title">Devolucion - I05  <a href="produccion.php" class="btn btn-success" role="button">Nuevo Ingreso</a></h1>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/dash_dev.js"></script>
