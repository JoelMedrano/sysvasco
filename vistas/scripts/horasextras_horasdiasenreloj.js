...
function mostrar(id_cp) {
	$.post("../ajax/horasextras_horasdiasenreloj.php?op=mostrar", {
		id_cp: id_cp
...
function desabilitar_abono(id_cp) {
	bootbox.confirm("¿Está Seguro de desabilitar abono?", function (result) {
		if (result) {
			$.post("../ajax/horasextras_horasdiasenreloj.php?op=desabilitar_abono", {
				id_cp: id_cp
			}, function (e) {
				bootbox.alert(e);
				tabla.ajax.reload();
...
function habilitar_abono(id_cp) {
	bootbox.confirm("¿Está Seguro de habilitar abono?", function (result) {
		if (result) {
			$.post("../ajax/horasextras_horasdiasenreloj.php?op=habilitar_abono", {
				id_cp: id_cp
			}, function (e) {
				bootbox.alert(e);
				tabla.ajax.reload();
