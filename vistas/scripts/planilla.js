...
function guardaryeditardatos(e)
{
	...
	$.ajax({
		url: "../ajax/planilla.php?op=guardaryeditar_datos",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function guardaryeditar_data_adjunta(e)
{
	...
	$.ajax({
		url: "../ajax/planilla.php?op=guardaryeditar_data_adjunta",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
{
	$.post("../ajax/planilla.php?op=mostrar",{id_trab : id_trab}, function(data, status)
	{
