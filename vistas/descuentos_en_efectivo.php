              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Descuentos en Efectivo<button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <div class="form-group  col-xs-12">
                                   ...
                                   <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    ...
                                    <input type="hidden" readonly class="form-control" name="id_des_efe" id="id_des_efe">
...
<script type="text/javascript" src="scripts/descuentos_en_efectivo.js"></script>
<?php 
}
ob_end_flush();
?>