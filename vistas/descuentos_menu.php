              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Descuentos Menu<button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                           ...
                           <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <input type="hidden" readonly class="form-control" name="id_des_men" id="id_des_men" autocomplete="off">
                          ...
                          <div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">
                            ...
                            <input type="number" class="form-control" name="pagado" id="pagado" readonly  autocomplete="off">
                          </div>
                          <div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">
                            <label>Saldo</label>
                            <input type="number" class="form-control" name="saldo" id="saldo" readonly  autocomplete="off">
                          </div>
...
<script type="text/javascript" src="scripts/descuentos_menu.js"></script>
<?php 
}
ob_end_flush();
?>