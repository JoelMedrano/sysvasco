              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Contratos x Vencer</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        ...
                        <div class="form-inline col-lg-9 col-md-9 col-sm-9 col-xs-12">

                        </div>
                        <div class="form-inline col-lg-3 col-md-3 col-sm-3 col-xs-12">
                          <label>Mes x Vencer:</label>
                          <select name="id_mes" id="id_mes" class="form-control selectpicker" data-live-search="true"
                            required>
                          </select>
                        ...
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            ...
                            <th>Funcion</th>
                            <th>Nombres</th>
                            <th>Inicio Ultimo Contrato</th>
                            <th>Fin Ultimo Contrato</th>
                            <th>Tiempo Renovacion</th>
                            <th>Situacion</th>
                          </thead>
                          <tbody>                            
                          </tbody>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/contratos_filtrovencimiento.js"></script>
<?php 
}
ob_end_flush();
?>
